...
/**
 * Variabel untuk mengambil data nama team dan alamat url logo team
 * Digunakan oleh Retrofit, juga Room
 *
 * @Entity = Untuk menentukan nama tabel dan kolom nya
 */
@Entity(tableName = "team")
public class TeamDetail {

    /**
     * Diset untuk menjadi primary key di table local (SQLite)
     */
    @PrimaryKey(autoGenerate = true)
    public int mId;
    /**
     * @ColumnInfo = Untuk menentukan nama kolom nya
     */
    ...
    /**
     * Konstruktor kelas dengan fungsi getter untuk masing - masing variabel nya
     */
